    ...
    <section id="kontakt" className="section-shell px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
      <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:items-start">
        <motion.div
          ...
          className="paper-panel min-w-0 rounded-[2rem] p-7 sm:p-8"
        >
          ...
          <div className="mt-10 flex flex-col gap-4 sm:flex-row">
            <button
              ...
              className="rounded-full bg-accent px-6 py-3.5 text-sm font-semibold text-secondary"
            >
              Termin vereinbaren
            </button>
            <a
              ...
              className="rounded-full border border-line px-6 py-3.5 text-sm font-semibold text-secondary transition-colors hover:border-primary/30 hover:text-primary"
            >
              Route öffnen
            </a>
          </div>
        ...
        <motion.div
          ...
          className="relative min-w-0 min-h-[420px] overflow-hidden rounded-[2rem] border border-line shadow-[0_20px_46px_rgba(34,49,56,0.08)]"
        >
          <iframe
