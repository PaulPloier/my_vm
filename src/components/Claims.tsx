...
export const Claims: React.FC<ClaimsProps> = ({ onOpenAppointment }) => {
  return (
    <section className="px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
      <div className="mx-auto grid max-w-7xl gap-8 bg-secondary px-6 py-10 text-paper sm:px-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,0.9fr)] lg:px-14 lg:py-14">
        <motion.div
        ...
        <motion.div
          ...
          className="border border-white/12 bg-white/5 p-6 text-paper"
        >
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <button onClick={onOpenAppointment} className="bg-primary px-6 py-3 text-sm font-semibold text-white">
              Beratungstermin anfragen
            </button>
            <a
              href="tel:+4372895072"
              className="border border-paper/25 px-6 py-3 text-sm font-semibold text-paper transition-colors hover:bg-paper/10"
            >
              +43 (0) 7289 / 5072
            </a>
          </div>
